...
},{"regenerator-runtime":12}],4:[function(require,module,exports){
...
if (window.location.href.indexOf('/') > -1) {
  window.$vueHome = new Vue({
    ...
    data: {
      ...
      useEpoch: false,
      pieCharts: [],
      pieColors: ['#dc5b64', '#4e79e6', '#3399b6', '#edc437'],
      candidates: null,
      candidates_page: 1,
      selectedState: null,
      selectedCity: null,
          ...
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  _context.next = 4;
                  return _this2.generateChart();

                case 4:
                  _context.next = 6;
                  return _this2.generatePieCharts();
    ...
    methods: {
      ...
      handlePieData: function handlePieData(data) {
      ...
      generatePieChartColors: function generatePieChartColors(baseColor) {
        ...
        for (i = 0; i < 33; i += 1) {
          ...
          if (i < 6) {
            colors.push(_highcharts.default.color(base).brighten(i / 7).get());
          } else {
            colors.push(_highcharts.default.color(base).brighten(i / 34).get());
          }
        }
      ...
      generateChart: function generateChart() {
        this.chart = _highcharts.default.chart('js-main-chart', {
          chart: {
            type: 'line'
          },
          title: {
          ...
          _highcharts.default.chart("js-chart__".concat(chart.type), {
            ...
            plotOptions: {
              pie: {
                ...
                dataLabels: {
                  enabled: true,
                  format: '<b>{point.name}</b><br>{point.percentage:.1f} %' // distance: -50,
                  // filter: {
                  //   property: 'percentage',
                  //   operator: '>',
                  //   value: 4,
...
},{"./config":13,"@babel/runtime/helpers/asyncToGenerator":1,"@babel/runtime/helpers/interopRequireDefault":2,"@babel/runtime/regenerator":3,"dayjs":4,"dayjs/locale/pt-br":5,"dayjs/plugin/duration":6,"highcharts":7,"highcharts/modules/export-data":8,"highcharts/modules/exporting":9,"micromodal":10,"numeral":11}],15:[function(require,module,exports){
"use strict";
...
},{"./home":14,"./menuToggle":16,"@babel/runtime/helpers/interopRequireDefault":2}],16:[function(require,module,exports){
"use strict";
